...
const RidePopup = (props) => {
    ...
    return (
        <div>
            <h5 className='absolute top-4 right-4 text-3xl ' onClick={() => props.setRidePopups(false)} >
                <i className="ri-close-circle-line"></i>
            </h5>
            <h3 className='text-2xl font-semibold text-black mb-5'>New Ride Availabele!</h3>
